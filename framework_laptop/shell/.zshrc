...
[[ -f ~/.oh-my-zsh/plugins/zsh-snap/znap.zsh ]] ||
    git clone --depth 1 -- \
        https://github.com/marlonrichert/zsh-snap.git ~/.oh-my-zsh/plugins/zsh-snap/znap.zsh
...
# Maven
export PATH=$HOME/bin/apache-maven-3.8.5/bin:$PATH
